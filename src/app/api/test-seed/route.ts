...
const GHOST_USERS = [
  ...
  { name: "Olamide Soyinka", email: "olamide.soyinka" },
  { name: "Damilola Adeboye", email: "dami.adeboye" },
  { name: "Yusuf Ibrahim", email: "yusuf.ibrahim" },
  { name: "Funmi Adesuwa", email: "funmi.adesuwa" },
  { name: "Kelechi Iheanacho", email: "kelechi.i" },
];
...
export async function POST() {
  try {
    ...
    return NextResponse.json({ success: true, message: "Wiped and seeded 15 leads with referrals to trigger See More" });
  } catch (error: any) {
