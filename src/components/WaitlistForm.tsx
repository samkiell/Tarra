...
const WaitlistForm: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-lg bg-dark/40 border border-muted/10 rounded-2xl p-8 sm:p-12 shadow-2xl backdrop-blur-md transition-all duration-300 text-left">
