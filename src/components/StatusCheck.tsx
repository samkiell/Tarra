    ...
    <div className="w-full max-w-sm mx-auto mt-8 text-center">
      ...
      <form onSubmit={handleSubmit} className="flex gap-2">
        <input
          ...
          className="flex-grow px-4 py-2 text-sm border border-stone-200 dark:border-stone-800 rounded text-stone-900 dark:text-stone-50 bg-white dark:bg-stone-950 focus:outline-none focus:ring-1 focus:ring-primary transition-all"
          value={phone}
